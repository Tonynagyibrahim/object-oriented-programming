...
public class AddCarForm extends Scene{
    ...
    /////////////////////////////////////////
        ...
        Label note= new   Label(" NOTE: To 'Delete' Car ID is only enough ");
        ...
        add_btn.setOnAction((ActionEvent event) -> {
           ...
           try{
               ...
               if(!price_tb.getText().contentEquals("")){
                    alert.setContentText("Enter Valid Price ");
                    alert.showAndWait();
                    price_tb.setText("");
                }
           }
               ...
               alert.setContentText("Please Fill All The Form ");
                 ...
                 try {
                     ...
                     if (mess.contentEquals("Invalid ID ,Enter Another One")){
                             alert.setContentText("Car ID is Taken");
                             alert.showAndWait();
                     ...
                     System.out.println("File Manager Exception Not Found");
                 }
           }
        });
        ///////////////////////
    ...
    primaryStage.setScene(mm1);
     primaryStage.show();
        ...
        edit_btn.setOnAction((ActionEvent event) -> {
             ...
             if(!year_tb.getText().contentEquals("")){
                    alert.setContentText("Enter Valid Release Year ");
                    alert.showAndWait();
                    year_tb.setText("");
             }
           }
               ...
               alert.setContentText("Please Fill All The Form ");
                 ...
                 try {
                     ...
                     if (b1){
                         ...
                         alert.setContentText("Wrong Car ID");
                             alert.showAndWait();
                             carId_tb.setText("");
                     ...
                     Logger.getLogger(AddCarForm.class.getName()).log(Level.SEVERE, null, ex);
                     System.out.println("File Manager Not Found");
                 }
           }       
        });
